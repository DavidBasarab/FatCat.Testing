...
public class CharComparer(char subject) : ComparerBase<char, CharComparer>(subject)
{
	...
	public CharComparer BeControl(string because = null)
	{
		...
		{
			CompareException.New(because ?? $"{Subject} should be a control character");
		}
	...
	public CharComparer BeDigit(string because = null)
	{
		...
		{
			CompareException.New(because ?? $"{Subject} should be a digit");
		}
	...
	public CharComparer BeLetter(string because = null)
	{
		...
		{
			CompareException.New(because ?? $"{Subject} should be a letter");
		}
	...
	{
		if (!char.IsLetterOrDigit(Subject))
		{
			CompareException.New(because ?? $"{Subject} should be a letter or digit");
		}
	...
	{
		if (!char.IsLower(Subject))
		{
			CompareException.New(because ?? $"{Subject} should be lower cased");
		}
	...
	{
		if (!char.IsUpper(Subject))
		{
			CompareException.New(because ?? $"{Subject} should be upper cased");
		}
	...
	public CharComparer BeWhiteSpace(string because = null)
	{
		...
		{
			CompareException.New(because ?? $"{Subject} should be white space");
		}
