...
public static class ShouldExtensions
{
	...
	public static DoubleComparer Should(this double subject) { return new DoubleComparer(subject); }

	public static FloatComparer Should(this float subject) { return new FloatComparer(subject); }
