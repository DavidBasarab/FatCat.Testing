...
{
	[Fact]
	public void BadHaveFlag() { RunCompareFailTest(() => TestStatus.Active.Should().HaveFlag(TestStatus.Pending)); }
	...
	[Fact]
	public void GoodHaveFlag() { (TestStatus.Active | TestStatus.Pending).Should().HaveFlag(TestStatus.Active); }

	[Fact]
	public void GoodNotHaveFlag() { TestStatus.Active.Should().Not.HaveFlag(TestStatus.Pending); }
}