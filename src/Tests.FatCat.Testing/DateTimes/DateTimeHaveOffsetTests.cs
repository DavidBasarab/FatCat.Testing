...
public class DateTimeHaveOffsetTests : BaseTest
{
	[Fact]
	public void BadHaveOffset()
	{
		...
		RunCompareFailTest(() => utcDate.Should().HaveOffset(TimeSpan.FromHours(5)));
	}

	[Fact]
	public void BadHaveOffsetShowsCorrectMessage()
	{
		var utcDate = new DateTime(2024, 6, 15, 10, 30, 45, DateTimeKind.Utc);
	...
	public void BadNotHaveOffset()
	{
		...
		RunCompareFailTest(() => utcDate.Should().Not.HaveOffset(TimeSpan.Zero));
	}

	[Fact]
	public void BadNotHaveOffsetShowsCorrectMessage()
	{
		var utcDate = new DateTime(2024, 6, 15, 10, 30, 45, DateTimeKind.Utc);
	...
	public void GoodHaveOffset()
	{
		...
		utcDate.Should().HaveOffset(TimeSpan.Zero);
	}
	...
	public void GoodNotHaveOffset()
	{
		...
		utcDate.Should().Not.HaveOffset(TimeSpan.FromHours(5));
	}
}
