...
public class NullableDateTimeHaveSecondTests : BaseTest
{
	[Fact]
	...
	public void BadHaveSecondWithBecause()
	{
		...
		RunCompareFailTest(() => ((DateTime?)date).Should().HaveSecond(46, "custom because"), "custom because");
	}
	...
	public void GoodHaveSecond()
	{
		...
		((DateTime?)date).Should().HaveSecond(45);
	}
	...
	public void GoodNotHaveSecond()
	{
		...
		((DateTime?)date).Should().Not.HaveSecond(46);
	}
