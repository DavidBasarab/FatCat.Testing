...
{
	[Fact]
	public void BadEndWith() { RunCompareFailTest(() => "hello world".Should().EndWith("hello"), "hello world should end with hello"); }

	[Fact]
	public void BadEndWithDifferentCase() { RunCompareFailTest(() => "hello world".Should().EndWith("WORLD"), "hello world should end with WORLD"); }
	...
	[Fact]
	public void BadEndWithWhenNull() { RunCompareFailTest(() => ((string)null).Should().EndWith("world"), "null should end with world"); }
	...
	[Fact]
	public void GoodEndWith() { "hello world".Should().EndWith("world"); }

	[Fact]
	public void GoodEndWithEquivalentOf() { "hello world".Should().EndWithEquivalentOf("WORLD", Options.IgnoreCase); }

	[Fact]
	public void GoodEndWithIgnoreCase() { "hello world".Should().EndWith("WORLD", Options.IgnoreCase); }

	[Fact]
	public void GoodNotEndWith() { "hello world".Should().Not.EndWith("hello"); }

	[Fact]
	public void GoodNotEndWithEquivalentOf() { "hello world".Should().Not.EndWithEquivalentOf("HELLO"); }

	[Fact]
	public void GoodNotEndWithIgnoreCase() { "hello world".Should().Not.EndWith("HELLO", Options.IgnoreCase); }

	[Fact]
	public void GoodNotEndWithWhenNull() { ((string)null).Should().Not.EndWith("world"); }
}