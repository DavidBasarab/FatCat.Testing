...
public class StringContainTests : BaseTest
{
	...
	[Fact]
	public void BadContainDifferentCase() { RunCompareFailTest(() => "hello world".Should().Contain("HELLO"), "hello world should contain HELLO"); }
	...
	[Fact]
	public void GoodContainAll() { "hello world".Should().ContainAll(["hello", "world"]); }

	[Fact]
	public void GoodContainAllIgnoreCase() { "hello world".Should().ContainAll(["HELLO", "WORLD"], Options.IgnoreCase); }

	[Fact]
	public void GoodContainAny() { "hello world".Should().ContainAny(["hello", "xyz"]); }

	[Fact]
	public void GoodContainAnyIgnoreCase() { "hello world".Should().ContainAny(["HELLO", "XYZ"], Options.IgnoreCase); }

	[Fact]
	public void GoodContainAtLeastTimes() { "ab ab ab".Should().Contain("ab", AtLeast.Times(2)); }

	[Fact]
	public void GoodContainAtLeastTwice() { "hello hello hello".Should().Contain("hello", AtLeast.Twice()); }

	[Fact]
	public void GoodContainAtMostThrice() { "hello hello".Should().Contain("hello", AtMost.Thrice()); }

	[Fact]
	public void GoodContainAtMostTimes() { "ab ab".Should().Contain("ab", AtMost.Times(5)); }

	[Fact]
	public void GoodContainExactlyOnce() { "hello world".Should().Contain("hello", Exactly.Once()); }

	[Fact]
	public void GoodContainExactlyTimes() { "ab ab ab".Should().Contain("ab", Exactly.Times(3)); }

	[Fact]
	public void GoodContainIgnoreCase() { "hello world".Should().Contain("HELLO", Options.IgnoreCase); }

	[Fact]
	public void GoodContainLessThanThrice() { "hello hello".Should().Contain("hello", LessThan.Thrice()); }

	[Fact]
	public void GoodContainLessThanTimes() { "ab ab".Should().Contain("ab", LessThan.Times(5)); }

	[Fact]
	public void GoodContainMoreThanOnce() { "hello hello".Should().Contain("hello", MoreThan.Once()); }

	[Fact]
	public void GoodContainMoreThanTimes() { "ab ab ab".Should().Contain("ab", MoreThan.Times(2)); }

	[Fact]
	public void GoodNotContain() { "hello world".Should().Not.Contain("xyz"); }

	[Fact]
	public void GoodNotContainAllMissingSome() { "hello world".Should().Not.ContainAll(["hello", "xyz"]); }

	[Fact]
	public void GoodNotContainAllWhenNull() { ((string)null).Should().Not.ContainAll(["hello"]); }

	[Fact]
	public void GoodNotContainAny() { "hello world".Should().Not.ContainAny(["xyz", "abc"]); }

	[Fact]
	public void GoodNotContainAnyWhenNull() { ((string)null).Should().Not.ContainAny(["hello"]); }

	[Fact]
	public void GoodNotContainIgnoreCase() { "hello world".Should().Not.Contain("XYZ", Options.IgnoreCase); }
