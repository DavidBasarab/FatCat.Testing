...
public class NullableStringStartWithTests : BaseTest
{
	...
	[Fact]
	public void GoodNotStartWith() { ((string?)"hello world").Should().Not.StartWith("world"); }

	[Fact]
	public void GoodNotStartWithWhenNull() { ((string?)null).Should().Not.StartWith("hello"); }

	[Fact]
	public void GoodStartWith() { ((string?)"hello world").Should().StartWith("hello"); }

	[Fact]
	public void GoodStartWithEquivalentOf() { ((string?)"hello world").Should().StartWithEquivalentOf("hello"); }

	[Fact]
	public void GoodStartWithIgnoreCase() { ((string?)"hello world").Should().StartWith("HELLO", Options.IgnoreCase); }
}