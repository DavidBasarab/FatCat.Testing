...
{
	[Fact]
	public void BadMatch() { RunCompareFailTest(() => ((string?)"hello").Should().Match("world*"), "hello should match world*"); }
	...
	[Fact]
	public void GoodMatch() { ((string?)"hello world").Should().Match("hello*"); }

	[Fact]
	public void GoodMatchIgnoreCase() { ((string?)"hello world").Should().Match("HELLO*", Options.IgnoreCase); }

	[Fact]
	public void GoodMatchWildcardQuestion() { ((string?)"hello").Should().Match("hell?"); }

	[Fact]
	public void GoodNotMatch() { ((string?)"hello").Should().Not.Match("world*"); }
