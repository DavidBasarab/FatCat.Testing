...
public class GuidBeTests : BaseTest
{
	...
	public void BadBe()
	{
		RunCompareFailTest(() => TestGuid.Should().Be(Guid.Empty));
	}
	...
	{
		RunCompareFailTest(() => TestGuid.Should().Be(Guid.Empty, "custom because"), "custom because");
	}

	[Fact]
	public void BadNotBe()
	{
		RunCompareFailTest(() => TestGuid.Should().Not.Be(TestGuid));
	}
	...
	{
		RunCompareFailTest(() => TestGuid.Should().Not.Be(TestGuid, "custom because"), "custom because");
	}

	[Fact]
	public void GoodBe()
	{
		TestGuid.Should().Be(TestGuid);
	}

	[Fact]
	public void GoodNotBe()
	{
		TestGuid.Should().Not.Be(Guid.Empty);
	}
}
