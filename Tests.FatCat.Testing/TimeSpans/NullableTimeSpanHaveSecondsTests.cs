...
public class NullableTimeSpanHaveSecondsTests : BaseTest
{
	...
	public void BadNotHaveSeconds()
	{
		...
		RunCompareFailTest(() => ((TimeSpan?)span).Should().Not.HaveSeconds(45), "00:00:45 should not have seconds 45");
	}
	...
	public void BadNotHaveSecondsWithBecause()
	{
		...
		RunCompareFailTest(() => ((TimeSpan?)span).Should().Not.HaveSeconds(45, "custom because"), "custom because");
	}
