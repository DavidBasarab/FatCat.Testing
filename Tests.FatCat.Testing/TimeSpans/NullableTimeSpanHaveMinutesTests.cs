...
public class NullableTimeSpanHaveMinutesTests : BaseTest
{
	...
	[Fact]
	public void BadHaveMinutesNullValue()
	{
		RunCompareFailTest(() => ((TimeSpan?)null).Should().HaveMinutes(45), "null should have minutes 45");
	}
	...
	public void BadNotHaveMinutes()
	{
		...
		RunCompareFailTest(() => ((TimeSpan?)span).Should().Not.HaveMinutes(30), "00:30:00 should not have minutes 30");
	}
	...
	public void BadNotHaveMinutesWithBecause()
	{
		...
		RunCompareFailTest(() => ((TimeSpan?)span).Should().Not.HaveMinutes(30, "custom because"), "custom because");
	}
	...
	[Fact]
	public void GoodNotHaveMinutesWhenNull()
	{
		((TimeSpan?)null).Should().Not.HaveMinutes(30);
	}
}
