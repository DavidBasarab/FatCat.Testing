...
public class EnumBeTests : BaseTest
{
	...
	{
		RunCompareFailTest(() => TestStatus.Active.Should().Be(TestStatus.Inactive, "custom because"), "custom because");
	}
	...
	{
		RunCompareFailTest(() => TestStatus.Active.Should().Not.Be(TestStatus.Active), "Active should not be Active");
	}

	[Fact]
	public void BadNotBeWithBecause()
	{
		RunCompareFailTest(() => TestStatus.Active.Should().Not.Be(TestStatus.Active, "custom because"), "custom because");
	}
