...
{
	[Fact]
	public void BadHaveSameValueAs()
	{
		RunCompareFailTest(() => TestStatus.Active.Should().HaveSameValueAs(OtherStatus.Disabled));
	}
	...
	[Fact]
	public void BadNotHaveSameValueAs()
	{
		RunCompareFailTest(() => TestStatus.Inactive.Should().Not.HaveSameValueAs(OtherStatus.Disabled));
	}
	...
	[Fact]
	public void GoodHaveSameValueAs()
	{
		TestStatus.Inactive.Should().HaveSameValueAs(OtherStatus.Disabled);
	}

	[Fact]
	public void GoodNotHaveSameValueAs()
	{
		TestStatus.Active.Should().Not.HaveSameValueAs(OtherStatus.Disabled);
	}
}
