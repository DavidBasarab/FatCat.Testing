...
{
	[Fact]
	public void BadHaveSameNameAs() { RunCompareFailTest(() => TestStatus.Active.Should().HaveSameNameAs(OtherStatus.Disabled)); }
	...
	[Fact]
	public void BadNotHaveSameNameAs() { RunCompareFailTest(() => TestStatus.Active.Should().Not.HaveSameNameAs(OtherStatus.Active)); }
	...
	[Fact]
	public void GoodHaveSameNameAs() { TestStatus.Active.Should().HaveSameNameAs(OtherStatus.Active); }

	[Fact]
	public void GoodNotHaveSameNameAs() { TestStatus.Active.Should().Not.HaveSameNameAs(OtherStatus.Disabled); }
}