...
public class DateTimeHaveMillisecondTests : BaseTest
{
	...
	public void BadHaveMillisecondShowsCorrectMessage()
	{
		...
		RunCompareFailTest(() => date.Should().HaveMillisecond(600), "2024-06-15 10:30:45 should have millisecond 600");
	}
	...
	public void BadNotHaveMillisecondShowsCorrectMessage()
	{
		...
		RunCompareFailTest(() => date.Should().Not.HaveMillisecond(500), "2024-06-15 10:30:45 should not have millisecond 500");
	}
