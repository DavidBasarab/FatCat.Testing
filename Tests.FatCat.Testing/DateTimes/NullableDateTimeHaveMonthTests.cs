...
public class NullableDateTimeHaveMonthTests : BaseTest
{
	...
	public void BadHaveMonth()
	{
		...
		RunCompareFailTest(() => ((DateTime?)date).Should().HaveMonth(7), "2024-06-15 10:30:45 should have month 7");
	}
	...
	public void BadNotHaveMonth()
	{
		...
		RunCompareFailTest(() => ((DateTime?)date).Should().Not.HaveMonth(6), "2024-06-15 10:30:45 should not have month 6");
	}
