...
public class NullableDateTimeHaveYearTests : BaseTest
{
	...
	public void BadHaveYear()
	{
		...
		RunCompareFailTest(() => ((DateTime?)date).Should().HaveYear(2025), "2024-06-15 10:30:45 should have year 2025");
	}
	...
	public void BadNotHaveYearWithBecause()
	{
		...
		RunCompareFailTest(() => ((DateTime?)date).Should().Not.HaveYear(2024, "custom because"), "custom because");
	}
