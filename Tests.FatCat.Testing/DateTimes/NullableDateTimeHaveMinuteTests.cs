...
public class NullableDateTimeHaveMinuteTests : BaseTest
{
	...
	public void BadHaveMinute()
	{
		...
		RunCompareFailTest(() => ((DateTime?)date).Should().HaveMinute(31), "2024-06-15 10:30:45 should have minute 31");
	}
	...
	public void BadNotHaveMinuteWithBecause()
	{
		...
		RunCompareFailTest(() => ((DateTime?)date).Should().Not.HaveMinute(30, "custom because"), "custom because");
	}
