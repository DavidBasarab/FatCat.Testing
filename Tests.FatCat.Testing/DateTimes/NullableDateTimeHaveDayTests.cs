...
public class NullableDateTimeHaveDayTests : BaseTest
{
	...
	[Fact]
	public void BadHaveDayNullValue()
	{
		RunCompareFailTest(() => ((DateTime?)null).Should().HaveDay(16), "null should have day 16");
	}
	...
	public void BadNotHaveDay()
	{
		...
		RunCompareFailTest(() => ((DateTime?)date).Should().Not.HaveDay(15), "2024-06-15 10:30:45 should not have day 15");
	}
	...
	[Fact]
	public void GoodNotHaveDayWhenNull()
	{
		((DateTime?)null).Should().Not.HaveDay(15);
	}
}
