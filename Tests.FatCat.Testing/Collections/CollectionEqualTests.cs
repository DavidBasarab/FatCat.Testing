...
{
	[Fact]
	public void GoodEqual() { new List<int> { 1, 2, 3 }.Should().Equal(new List<int> { 1, 2, 3 }); }

	[Fact]
	public void BadEqual() { RunCompareFailTest(() => new List<int> { 1, 2, 3 }.Should().Equal(new List<int> { 1, 2, 4 })); }

	[Fact]
	public void BadEqualShowsCorrectMessage()
	{
		RunCompareFailTest(
							() => new List<int> { 1, 2, 3 }.Should().Equal(new List<int> { 1, 2, 4 }),
	...
	{
		RunCompareFailTest(
							() => new List<int> { 1, 2, 3 }.Should().Equal(new List<int> { 3, 2, 1 }),
	...
	{
		RunCompareFailTest(
							() => new List<int> { 1, 2, 3 }.Should().Equal(new List<int> { 1, 2 }),
	...
	{
		RunCompareFailTest(() => new List<int> { 1, 2, 3 }.Should().Equal(new List<int> { 1, 2, 4 }, "custom because"), "custom because");
	}
