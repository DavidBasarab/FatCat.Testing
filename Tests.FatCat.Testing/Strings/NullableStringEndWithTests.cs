...
public class NullableStringEndWithTests : BaseTest
{
	...
	[Fact]
	public void GoodEndWith() { ((string?)"hello world").Should().EndWith("world"); }

	[Fact]
	public void GoodEndWithEquivalentOf() { ((string?)"hello world").Should().EndWithEquivalentOf("world"); }

	[Fact]
	public void GoodEndWithIgnoreCase() { ((string?)"hello world").Should().EndWith("WORLD", Options.IgnoreCase); }

	[Fact]
	public void GoodNotEndWith() { ((string?)"hello world").Should().Not.EndWith("hello"); }
