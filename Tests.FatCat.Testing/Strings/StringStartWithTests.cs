...
public class StringStartWithTests : BaseTest
{
	...
	{
		RunCompareFailTest(() => "hello world".Should().Not.StartWith("hello"), "hello world should not start with hello");
	}
	...
	{
		RunCompareFailTest(() => "hello world".Should().Not.StartWith("hello", because: "custom because"), "custom because");
	}
	...
	[Fact]
	public void BadStartWithDifferentCase()
	{
	...
	{
		RunCompareFailTest(() => "hello world".Should().StartWith("world", because: "custom because"), "custom because");
	}
	...
	[Fact]
	public void GoodNotStartWithIgnoreCase()
	{
