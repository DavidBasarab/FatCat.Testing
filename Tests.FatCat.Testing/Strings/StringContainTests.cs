...
public class StringContainTests : BaseTest
{
	...
	{
		RunCompareFailTest(() => ((string)null).Should().ContainAll(["hello"]), "null should contain all of [hello]");
	}

	[Fact]
	public void BadContainAllWithBecause()
	{
		RunCompareFailTest(() => "hello world".Should().ContainAll(["xyz"], because: "custom because"), "custom because");
	}
	...
	{
		RunCompareFailTest(() => ((string)null).Should().ContainAny(["hello"]), "null should contain at least one of [hello]");
	}

	[Fact]
	public void BadContainAnyWithBecause()
	{
		RunCompareFailTest(() => "hello world".Should().ContainAny(["xyz"], because: "custom because"), "custom because");
	}
	...
	{
		RunCompareFailTest(() => "hello world".Should().Contain("xyz", because: "custom because"), "custom because");
	}

	[Fact]
	public void BadNotContain()
	{
		RunCompareFailTest(() => "hello world".Should().Not.Contain("hello"), "hello world should not contain hello");
	}
	...
	{
		RunCompareFailTest(() => "hello world".Should().Not.ContainAny(["hello"], because: "custom because"), "custom because");
	}
	...
	{
		RunCompareFailTest(() => "hello world".Should().Not.Contain("hello", because: "custom because"), "custom because");
	}
