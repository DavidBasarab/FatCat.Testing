...
public class StringBeEquivalentToTests : BaseTest
{
	...
	{
		RunCompareFailTest(() => "hello".Should().BeEquivalentTo("world", because: "custom because"), "custom because");
	}

	[Fact]
	public void BadNotBeEquivalentTo()
	{
		RunCompareFailTest(() => "hello".Should().Not.BeEquivalentTo("hello"), "hello should not be equivalent to hello");
	}
	...
	{
		RunCompareFailTest(() => "hello".Should().Not.BeEquivalentTo("hello", because: "custom because"), "custom because");
	}
