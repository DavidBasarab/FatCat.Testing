...
public class StringBeTests : BaseTest
{
	...
	{
		RunCompareFailTest(() => "hello".Should().Be("world", Options.IgnoreCase, "custom because"), "custom because");
	}
	...
	{
		RunCompareFailTest(() => "hello".Should().Not.Be("HELLO", Options.IgnoreCase), "hello should not be HELLO");
	}
