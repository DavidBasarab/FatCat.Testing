...
public class StringEndWithTests : BaseTest
{
	...
	{
		RunCompareFailTest(() => "hello world".Should().EndWith("hello", because: "custom because"), "custom because");
	}

	[Fact]
	public void BadNotEndWith()
	{
		RunCompareFailTest(() => "hello world".Should().Not.EndWith("world"), "hello world should not end with world");
	}
	...
	{
		RunCompareFailTest(() => "hello world".Should().Not.EndWith("world", because: "custom because"), "custom because");
	}
