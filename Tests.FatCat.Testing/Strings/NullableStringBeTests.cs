...
public class NullableStringBeTests : BaseTest
{
	...
	{
		RunCompareFailTest(() => ((string?)"hello").Should().Be("world", Options.IgnoreCase), "hello should be world");
	}
	...
	{
		RunCompareFailTest(() => ((string?)"hello").Should().Be("world", because: "custom because"), "custom because");
	}
	...
	{
		RunCompareFailTest(() => ((string?)"hello").Should().Not.Be("HELLO", Options.IgnoreCase), "hello should not be HELLO");
	}

	[Fact]
	public void BadNotBeWithBecause()
	{
		RunCompareFailTest(() => ((string?)"hello").Should().Not.Be("hello", because: "custom because"), "custom because");
	}
