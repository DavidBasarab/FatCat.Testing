...
public class NullableStringContainTests : BaseTest
{
	...
	{
		RunCompareFailTest(() => ((string?)"hello world").Should().Contain("xyz"), "hello world should contain xyz");
	}
	...
	{
		RunCompareFailTest(() => ((string?)"hello world").Should().Contain("xyz", because: "custom because"), "custom because");
	}
	...
	{
		((string?)"hello world").Should().Contain("hello");
	}

	[Fact]
	public void GoodContainAll()
	{
		((string?)"hello world").Should().ContainAll(["hello", "world"]);
	}

	[Fact]
	public void GoodContainAny()
	{
		((string?)"hello world").Should().ContainAny(["hello", "xyz"]);
	}

	[Fact]
	public void GoodNotContain()
	{
		((string?)"hello world").Should().Not.Contain("xyz");
	}

	[Fact]
	public void GoodNotContainAllMissingSome()
	{
		((string?)"hello world").Should().Not.ContainAll(["hello", "xyz"]);
	}
	...
	{
		((string?)"hello world").Should().Not.ContainAny(["xyz", "abc"]);
	}
