...
public class NullableStringBeNullOrWhiteSpaceTests : BaseTest
{
	...
	{
		RunCompareFailTest(() => ((string?)"hello").Should().BeNullOrWhiteSpace(), "hello should be null or whitespace");
	}

	[Fact]
	public void BadBeNullOrWhiteSpaceWithBecause()
	{
		RunCompareFailTest(() => ((string?)"hello").Should().BeNullOrWhiteSpace("custom because"), "custom because");
	}

	[Fact]
	public void BadNotBeNullOrWhiteSpaceWhenNull()
	{
		RunCompareFailTest(() => ((string?)null).Should().Not.BeNullOrWhiteSpace(), "null should not be null or whitespace");
	}

	[Fact]
	public void BadNotBeNullOrWhiteSpaceWhenWhiteSpace()
	{
		RunCompareFailTest(() => ((string?)"   ").Should().Not.BeNullOrWhiteSpace(), "    should not be null or whitespace");
	}

	[Fact]
	public void BadNotBeNullOrWhiteSpaceWithBecause()
	{
		RunCompareFailTest(() => ((string?)null).Should().Not.BeNullOrWhiteSpace("custom because"), "custom because");
	}
