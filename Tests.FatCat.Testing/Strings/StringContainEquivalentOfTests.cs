...
public class StringContainEquivalentOfTests : BaseTest
{
	...
	{
		RunCompareFailTest(() => "hello world".Should().ContainEquivalentOf("xyz"));
	}
	...
	{
		"Hello World".Should().ContainEquivalentOf("hello");
	}

	[Fact]
	public void GoodNotContainEquivalentOf()
	{
		"Hello World".Should().Not.ContainEquivalentOf("xyz");
	}

	[Fact]
	public void GoodNotContainEquivalentOfWhenNull()
	{
		((string)null).Should().Not.ContainEquivalentOf("hello");
	}
}
