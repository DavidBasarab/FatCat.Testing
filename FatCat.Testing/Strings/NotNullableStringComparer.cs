...
public class NotNullableStringComparer(string? subject) : NotComparerBase<string?, NotNullableStringComparer>(subject)
{
	public NotNullableStringComparer Be(string expected, Options options = Options.CaseSensitive, string? because = null)
	{
	...
	public NotNullableStringComparer Contain(string expected, Options options = Options.CaseSensitive, string? because = null)
	{
	...
	)
	{
		...
		if (allContained)
		{
			CompareException.New(because ?? $"{Subject ?? "null"} should not contain all of [{string.Join(", ", expected)}]");
		}
	...
	)
	{
		...
		if (found.Count > 0)
		{
			CompareException.New(because ?? $"{Subject ?? "null"} should not contain any of [{string.Join(", ", expected)}]");
		}
	...
	public NotNullableStringComparer ContainEquivalentOf(string expected, string? because = null)
	{
		...
		{
			CompareException.New(because ?? $"{Subject} should not contain equivalent of {expected}");
		}

		return this;
	}

	public NotNullableStringComparer EndWith(string expected, Options options = Options.CaseSensitive, string? because = null)
	{
	...
	public NotNullableStringComparer Match(string pattern, Options options = Options.CaseSensitive, string? because = null)
	{
	...
	public NotNullableStringComparer StartWith(string expected, Options options = Options.CaseSensitive, string? because = null)
	{
