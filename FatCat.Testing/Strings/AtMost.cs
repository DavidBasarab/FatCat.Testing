...
public static class AtMost
{
	...
	{
		return new OccurrenceConstraint(1, OccurrenceMode.AtMost);
	}

	public static OccurrenceConstraint Thrice()
	{
		return new OccurrenceConstraint(3, OccurrenceMode.AtMost);
	}

	public static OccurrenceConstraint Times(int count)
	{
		return new OccurrenceConstraint(count, OccurrenceMode.AtMost);
	}

	public static OccurrenceConstraint Twice()
	{
		return new OccurrenceConstraint(2, OccurrenceMode.AtMost);
	}
}
