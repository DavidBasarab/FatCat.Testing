...
public class NullableTimeSpanComparer(TimeSpan? subject) : ComparerBase<TimeSpan?, NullableTimeSpanComparer>(subject)
{
	...
	public NullableTimeSpanComparer BeCloseTo(TimeSpan expected, TimeSpan precision, string because = null)
	{
		...
		{
			CompareException.New(because ?? $"{SubjectDisplay} should be within {precision} of {expected}");
		}
	...
	public NullableTimeSpanComparer HaveDays(int expected, string because = null)
	{
		...
		{
			CompareException.New(because ?? $"{SubjectDisplay} should have days {expected}");
		}
	...
	public NullableTimeSpanComparer HaveHours(int expected, string because = null)
	{
		...
		{
			CompareException.New(because ?? $"{SubjectDisplay} should have hours {expected}");
		}
	...
	public NullableTimeSpanComparer HaveMilliseconds(int expected, string because = null)
	{
		...
		{
			CompareException.New(because ?? $"{SubjectDisplay} should have milliseconds {expected}");
		}
	...
	public NullableTimeSpanComparer HaveMinutes(int expected, string because = null)
	{
		...
		{
			CompareException.New(because ?? $"{SubjectDisplay} should have minutes {expected}");
		}
	...
	public NullableTimeSpanComparer HaveSeconds(int expected, string because = null)
	{
		...
		{
			CompareException.New(because ?? $"{SubjectDisplay} should have seconds {expected}");
		}
